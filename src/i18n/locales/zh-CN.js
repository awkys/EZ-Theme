...
export default {
  ...
  dashboard: {
    ...
    importSubscription: "导入配置",
    purchasePlan: "购买套餐",
    resetTraffic: "重置流量",
    activateDataCycleInAdvance: "提前开启流量周期",
    resetDataCycleNotice:
      "点击「我知道了」将会扣除当前流量周期剩余服务时长（按月重置时扣除本周期剩余服务时长，每月1号重置时扣除整月时间30天，年周期同理），系统将会重置您的已使用流量。",
    ...
    pendingInvites: "待管理员处理奖励",
    // officialClients: "官方客户端",
    officialClients: "客户端下载",
    deviceLimit: "在线设备",
    unlimited: "不限制",
    ...
    copySubscriptionDesc: "复制配置链接到剪贴板",
    scanQRCode: "扫描二维码导入",
    ...
    subscriptionCopied: "配置链接已复制到剪贴板",
    copyFailed: "复制失败，请手动复制",
    manualImportRequired: "无法自动导入，请手动复制配置链接导入",
    noSubscription: "无可用配置",
    noClientsAvailable: "该平台暂无可用快速导入方式",
    clientNotInstalled: "您没有安装对应的客户端，已复制配置链接到剪贴板",
  },
  platforms: {
    ios: "iOS",
    android: "Android",
  ...
  nodes: {
    ...
    linkView: "链接",
    qrcodeView: "二维码",
    invalidNodeData: "资源数据不完整，无法生成链接",
    unsupportedNodeType: "不支持的资源类型",
    userInfoError: "获取用户信息失败",
    viewSubscribeLink: "查看配置链接",
  },
  orders: {
    title: "订单列表",
    loading: "正在加载订单...",
  ...
  profile: {
    ...
    subscription: "配置管理",
    resetSecurity: "重置配置",
    resetSecurityTitle: "重置配置链接",
    resetSecurityConfirm:
      "确定要重置配置吗？重置后，您之前的配置将失效，您需要重新导入新的配置。",
    resetSuccess: "重置成功",
    resetError: "重置失败",
    copySubscription: "复制配置链接",
    subscriptionCopied: "配置链接已复制",
    updateSuccess: "更新成功",
    updateError: "更新失败",
    ...
    saveChanges: "保存更改",
    cancel: "取消",
    noSubscription: "暂无配置链接",
    getSubscription: "获取配置链接",
  ...
  shop: {
    ...
    stats: {
      global_nodes: "服务资源",
      global_nodes_desc: "清晰展示可用资源",
      speed: "流畅体验",
      speed_desc: "稳定可靠的使用体验",
      streaming: "多场景支持",
      streaming_desc: "适配常用使用场景",
      devices: "多设备支持",
  ...
  invite: {
    title: "我的奖励",
    description: "邀请好友注册使用，获取奖励收入",
    stats: {
      registeredUsers: "已注册用户数",
      pendingCommission: "确认中的奖励",
      availableCommission: "累计获得奖励",
      commissionRate: "奖励比例",
    },
    rules: {
      title: "奖励规则",
    ...
    balance: {
      title: "奖励余额",
      available: "可用奖励",
      description: "邀请好友获得的奖励，可以直接划转到消费余额",
    ...
    transfer: {
      title: "划转奖励",
      warning: "注意",
      warningDesc: "划转后的余额仅用于消费使用，无法申请",
      amount: "划转金额",
      amountPlaceholder: "请输入划转金额",
      availableCommission: "可用奖励",
      confirm: "确认划转",
      processing: "处理中...",
      success: "划转成功",
      failure: "划转失败",
      insufficientFunds: "可用奖励不足",
    ...
    withdraw: {
      ...
      platform: "申请平台",
      account: "申请账号",
      accountPlaceholder: "请输入申请账号(收款信息)",
      amount: "申请金额",
      amountPlaceholder: "请输入申请金额",
      availableCommission: "可申请奖励",
      noPlatforms: "没有可用申请平台",
      confirm: "确认申请",
      processing: "处理中...",
      success: "申请已提交",
      failure: "申请失败",
      ...
      invalidAmount: "请输入有效的金额",
      insufficientFunds: "可用奖励不足",
      belowMinAmount: "申请金额不能低于{amount}",
      minWithdrawAmount: "最低申请金额",
    },
    inviteLink: {
      title: "邀请链接",
      createCode: "创建邀请码",
    ...
    records: {
      ...
      types: {
        confirmed_commission: "已确认奖励",
        pending_commission: "确认中奖励",
        all: "全部",
      },
    },
  },
  ...
  browserRestricted: {
    ...
    subtitle: "当前浏览器不受支持",
    description:
      "为了保证最佳的浏览体验和安全性，本网站不支持您正在使用的浏览器。",
